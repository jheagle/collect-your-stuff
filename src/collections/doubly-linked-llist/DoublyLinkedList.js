...
class DoublyLinkedList extends LinkedList {
   ...
   */
  constructor (listClass = DoublyLinkedList) {
    super(listClass)
  }
 ...
 * @returns {DoublyLinkedList}
 */
DoublyLinkedList.fromArray = (values = [], linkerClass = DoubleLinker, listClass = DoublyLinkedList) =>
  LinkedList.fromArray(values, linkerClass, listClass)
